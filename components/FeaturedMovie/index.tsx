...
const FeaturedMovie = ({ movie }: { movie: IMovie }) => {
    return (
        <section className='my-12  flex flex-col  gap-12'>
            ...
            <h3 className=' max-w-2xl overview md:text-2xl'>{movie.overview} </h3>
            <div className='flex flex-row gap-12'>
                <Link href={`/movie/${movie.id}`} className='py-5 px-12 md:px-32 font-bold text-xl bg-white  text-black  rounded-full animate-bounce '> Play</Link>
